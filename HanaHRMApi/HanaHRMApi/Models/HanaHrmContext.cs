...
public partial class HanaHrmContext : DbContext
{
    ...
    public HanaHrmContext(DbContextOptions<HanaHrmContext> options, IClientProvider clientProvider)
        : base(options)
    {
        _clientProvider = clientProvider;
    }

    public int CurrentClientId => _clientProvider.ClientId;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Department>(entity =>
        {
            ...
            entity.HasQueryFilter(e => e.IdClient == CurrentClientId);
        });
        ...
        modelBuilder.Entity<Designation>(entity =>
        {
            ...
            entity.HasQueryFilter(e => e.IsActive == true && e.IdClient == CurrentClientId);
        });
